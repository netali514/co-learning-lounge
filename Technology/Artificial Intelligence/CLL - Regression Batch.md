...
understanding about field of Data Science and Kaggle.*

**In Class**

*Brush up would be doen for basic Data Science concept and in class hand ons would be conducted on a dataset. All the models designed here would be on Regression case study.*

**Capstone**

*Whatever would be practicsed in class that would be under the guided mentorship but knowledge is built up only when practice is done. In this segment an old kaggle problem which is regression based would be alloted to learners to create and practice their own models and be ready to to participate in real tim kaggle competetions.*
...
developing accurate predictive models for Regression problem. Different machine learning algorithms are suited for different 
